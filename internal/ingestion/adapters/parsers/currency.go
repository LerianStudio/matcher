...
// isValidCurrencyCode checks if the given code is a valid ISO 4217 currency code.
// The code should be uppercase and exactly 3 characters.
func isValidCurrencyCode(code string) bool {
	if len(code) != maxCurrencyLength {
		return false
	}
