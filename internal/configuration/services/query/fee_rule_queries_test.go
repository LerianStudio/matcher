...
func (m *feeRuleMockRepoQ) Delete(_ context.Context, _ uuid.UUID, id uuid.UUID) error {
	delete(m.rules, id)
	return nil
}

func (m *feeRuleMockRepoQ) DeleteWithTx(_ context.Context, _ *sql.Tx, _ uuid.UUID, id uuid.UUID) error {
	delete(m.rules, id)
	return nil
}
