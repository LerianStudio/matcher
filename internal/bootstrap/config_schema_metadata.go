...
var fieldDescriptions = map[string]string{ //nolint:unused,gosec // Used by collectSchemaFields (reachable only from unit tests with build tag: unit). G101: UI description labels, not credentials.
	...
	"tenancy.multi_tenant_enabled":                     "Enable multi-tenant infrastructure isolation",
	"tenancy.multi_tenant_url":                         "Tenant settings service base URL",
	"tenancy.multi_tenant_environment":                 "Tenant settings environment scope (defaults to app.env_name when blank)",
	"tenancy.multi_tenant_max_tenant_pools":            "Maximum cached tenant infrastructure pools",
	"tenancy.multi_tenant_idle_timeout_sec":            "Tenant infrastructure idle eviction timeout in seconds",
	"tenancy.multi_tenant_circuit_breaker_threshold":   "Circuit breaker consecutive failure threshold for tenant settings",
	"tenancy.multi_tenant_circuit_breaker_timeout_sec": "Circuit breaker open timeout in seconds for tenant settings",
	"tenancy.multi_tenant_service_api_key":             "API key used to authenticate against tenant settings service",
	"tenancy.multi_tenant_infra_enabled":               "Deprecated alias for multi-tenant enablement",
...
var fieldLabels = map[string]string{ //nolint:unused // Used by collectSchemaFields (reachable only from unit tests with build tag: unit).
	...
	"tenancy.multi_tenant_enabled":                     "Multi-Tenant Enabled",
	"tenancy.multi_tenant_url":                         "Multi-Tenant URL",
	"tenancy.multi_tenant_environment":                 "Multi-Tenant Environment",
	"tenancy.multi_tenant_max_tenant_pools":            "Multi-Tenant Max Tenant Pools",
	"tenancy.multi_tenant_idle_timeout_sec":            "Multi-Tenant Idle Timeout (sec)",
	"tenancy.multi_tenant_circuit_breaker_threshold":   "Multi-Tenant Circuit Breaker Threshold",
	"tenancy.multi_tenant_circuit_breaker_timeout_sec": "Multi-Tenant Circuit Breaker Timeout (sec)",
	"tenancy.multi_tenant_service_api_key":             "Multi-Tenant Service API Key",
	"tenancy.multi_tenant_infra_enabled":               "Multi-Tenant Infra Enabled (Deprecated)",
